...
"""
    ...
    plt.suptitle('GPT-4o Vision - CIFAR-10 Evaluation Results', fontsize=16, fontweight='bold', y=0.98)
...
def main():
    ...
    # Generate visualizations in main folder
    ...
    plot_per_class_performance(
        results, 
        'gpt4o_per_class_performance.png'
    )
    
    plot_class_accuracy_comparison(
        results, 
        'gpt4o_class_accuracy.png'
    )
    
    plot_summary_dashboard(
        results, 
        'gpt4o_summary_dashboard.png'
    )
    
    print("\n" + "=" * 60)
    print("VISUALIZATION COMPLETE")
    print("=" * 60)
    print("\nGenerated files (in main folder):")
